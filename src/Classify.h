...
constexpr bool is_alhex(char c) {
...
constexpr bool is_oct_post(char c) {
  return c == 'O' || c == 'o' || c == 'Q' || c == 'q';
}
...
constexpr bool is_alpha_nonhex(char c) {
  return (c > 'F' && c <= 'Z') || (c > 'f' && c <= 'z');
}
constexpr bool is_ident_alnum(char c) { return is_alnum(c) || c == '_'; }
constexpr bool is_ident_nondigit(char c) { return is_alpha(c) || c == '_'; }
constexpr bool is_ident_nonhex(char c) {
  return is_alpha_nonhex(c) || c == '_';
}

constexpr bool is_non_kw(char c) { return is_dec(c) || c == '_'; }

constexpr bool is_a_or_c(char c) {
  return c == 'A' || c == 'a' || c == 'C' || c == 'c';
}
constexpr bool is_b_or_r(char c) {
  return c == 'b' || c == 'B' || c == 'r' || c == 'R';
}
